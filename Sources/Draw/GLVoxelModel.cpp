...
namespace spades {
	namespace draw {
		...
		void GLVoxelModel::RenderSunlightPass(std::vector<client::ModelRenderParam> params, bool farRender, bool ghostPass) {
			SPADES_MARK_FUNCTION();
		...
		void GLVoxelModel::RenderOccludedPass(std::vector<client::ModelRenderParam> params, bool farRender) {
			SPADES_MARK_FUNCTION();
		...
		void GLVoxelModel::RenderOcclusionTestPass(std::vector<client::ModelRenderParam> params, bool farRender) {
			SPADES_MARK_FUNCTION();

...
namespace spades {
	namespace draw {
		...
		public:
			...
			void RenderSunlightPass(std::vector<client::ModelRenderParam> params, bool farRender, bool ghostPass) override;

			void RenderDynamicLightPass(std::vector<client::ModelRenderParam> params,
			                            std::vector<GLDynamicLight> lights, bool farRender) override;

			virtual void RenderOutlinesPass(std::vector<client::ModelRenderParam> params,
				Vector3 outlineColor, bool fog, bool farRender);
			virtual void RenderOccludedPass(std::vector<client::ModelRenderParam> params, bool farRender);
			virtual void RenderOcclusionTestPass(std::vector<client::ModelRenderParam> params, bool farRender);
